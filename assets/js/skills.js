// main svg
var svg = d3.select("section").append("svg").attr("width", 1024).attr("height",2200),
width = +svg.attr("width"),
height = +svg.attr("height"),
g = svg.append("g").attr("transform", "translate(20,0)");       // move right 20px.

// x-scale and x-axis
var experienceName = ["", "Basic","Alright","Handy","Expert","Guru"];
...
d3.csv("/assets/profile.csv", row, function(error, data) {
